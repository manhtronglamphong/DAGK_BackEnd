...
exports.SharedBoardService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const shared_board_entity_1 = require("../entities/shared-board.entity");
const typeorm_2 = require("typeorm");
let SharedBoardService = class SharedBoardService {
    constructor(sharedBoardRepository) {
    ...
    async newsharedBoard(newsharedBoard) {
        const newl = await this.sharedBoardRepository.save(newsharedBoard);
        return { data: newl };
    }
};
SharedBoardService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(shared_board_entity_1.SharedBoard)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], SharedBoardService);
exports.SharedBoardService = SharedBoardService;
//# sourceMappingURL=shared-board.service.js.map